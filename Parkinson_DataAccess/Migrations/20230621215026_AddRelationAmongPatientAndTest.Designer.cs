...
namespace Parkinson_DataAccess.Migrations
{
    ...
    [Migration("20230621215026_AddRelationAmongPatientAndTest")]
    partial class AddRelationAmongPatientAndTest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parkinson_Models.PatientTest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Parkinson_Models.Patient", b =>
                {
                    b.HasOne("Parkinson_Models.Doctor", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("Parkinson_Models.PatientTest", b =>
                {
                    b.HasOne("Parkinson_Models.Patient", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Parkinson_Models.Test", "Test")
                        .WithMany()
